   ...
   <body>
        ...
        <div class="header-container">
            <header class="wrapper clearfix">
                <nav id="navlarge"> <!--Alternativ PHP syntax til active class fra http://php.net/manual/en/control-structures.alternative-syntax.php -->
                    <ul>
                        ...
                        <li><a  href="index.php"><img id="logolarge" src="./media/img/logohalf.png"></a></li>
                ...
                <nav id="navsmall"> <!--Alternativ PHP syntax til active class fra http://php.net/manual/en/control-structures.alternative-syntax.php -->
                    <ul>
                        <li><a <?php if($this_page == "om.php"):?>class="active"<?php endif;?> href="om.php"><? echo $city ?> Boulders</a></li>
                        <li><a <?php if($this_page == "praktiskinfo.php"):?>class="active"<?php endif;?> href="praktiskinfo.php">praktisk info</a></li>
                        <li><a <?php if($this_page == "okobar.php"):?>class="active"<?php endif;?> href="okobar.php">øko bar</a></li>
